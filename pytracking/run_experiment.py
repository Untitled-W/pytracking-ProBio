...
def main():
    ...
    parser.add_argument('--experiment_module', type=str, help='Name of experiment module in the experiments/ folder.',default='myexperiments')
    parser.add_argument('--experiment_name', type=str, help='Name of the experiment function.',default='probio_zeroshot')
